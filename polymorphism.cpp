...
class Employee:AbstractEmployee // Employee is a subclass of AbstractEmployee, signing a contract to implement the pure virtual function
{
	...
	public:
		...
		} // virtual keyword is used to make the function polymorphic, it can be overridden by subclasses: it will check the subclass first
...
class Developer: public Employee // Developer is a subclass of Employee (Inheritance)
{
	public:
		...
		void Work() // Overriding the Work function
		{
...
int main()
{
	...
	Employee* emp1 = &dev1; // Polymorphism
	Employee* emp2 = &teacher1; // Polymorphism
